...
df = df.drop(columns=[col for col in df.columns if col not in important_features and col != "match"])
...
profile.to_file("mixer_event_training.html")
print("pandas profiling done")
